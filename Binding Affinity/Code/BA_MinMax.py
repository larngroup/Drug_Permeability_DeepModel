# -*- coding: utf-8 -*-
"""
Created on Thu Jun 20 21:52:50 2024
...
def read_smiles_from_csv(file_path):
    ...
    return smiles_list, y_scaled, min_max_scaler
...
smiles_list, y_scaled, min_max_scaler = read_smiles_from_csv(file_path)
...
y_test_preds_original_scale = min_max_scaler.inverse_transform(best_run_params['preds'].reshape(-1, 1)).flatten()
y_test_original_scale = min_max_scaler.inverse_transform(y_test.reshape(-1, 1)).flatten()
